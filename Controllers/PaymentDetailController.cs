...
namespace PaymentAPI.Controllers
{
    ...
    public class PaymentDetailController : ControllerBase
    {
        ...
        {
            if (id != paymentDetails.PaymentCardDetailId)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<PaymentDetails>> PostPaymentDetails(PaymentDetails paymentDetails)
        {
            ...
            return CreatedAtAction("GetPaymentDetails", new { id = paymentDetails.PaymentCardDetailId }, paymentDetails);
        }
        ...
        {
            return _context.PaymentDetails.Any(e => e.PaymentCardDetailId == id);
        }
    }
}
